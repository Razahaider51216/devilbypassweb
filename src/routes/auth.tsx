      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 rounded-2xl border border-border bg-card p-6 text-center shadow-2xl">
          ...
          <a
            href="/login"
            target="_self"
            className="mt-6 inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-[#5865F2] px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#4752C4]"
          >
